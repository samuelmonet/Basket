...
def shot_chart_jointgrid(x, y, data=None, joint_type="scatter", title="",
                         joint_color="b", cmap=None,  xlim=(-800, 800),
                         ylim=(-200, 1300), court_color="gray", court_lw=1,
                         outer_lines=False, flip_court=False,
                         joint_kde_shade=True, gridsize=50,
...
def shot_chart_jointplot(x, y, data=None, kind="scatter", title="", color="b",
                         cmap=None, xlim=(-800, 800), ylim=(-200, 1300),
                         court_color="gray", court_lw=1, outer_lines=False,
   ...
   """
    ...
    grid = sns.jointplot(x=x, y=y, data=data, kind=kind,
...
def bokeh_shot_chart(data, x="COORD_X", y="COORD_Y", fill_color="#1f77b4",
